                ...
                <div class="col-lg-4">
                    <div class="room-details-side">
                        <div class="side-bar-form">
                            <h3>Booking Sheet </h3>
                            <form action="{{ route('store.user.booking',$roomDetails->id) }}" method="POST" id="bk_form">
                                @csrf
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input autocomplete="off" required type="text" name="check_in"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input autocomplete="off" required type="text" name="check_out"
                ...
                <div class="col-lg-8">
                    <div class="room-details-article">
                        ...
                        <div class="room-details-title">
                            ...
                            <ul>
                                <li><b> Basic : ${{ $roomDetails->price }}/Night/Room</b></li>
                            </ul>
                        </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-5 col-md-4 p-0">
                                    <div class="room-card-img">
                                        <a href="{{ url('room/details/' . $room->id) }}">
                                            <img src="{{ asset('upload/room_img/' . $room->image) }}" alt="Images">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-7 col-md-8 p-0">
                                    <div class="room-card-content">
                                        <h3>
                                            <a
                                                href="{{ url('room/details/' . $room->id) }}">{{ $room['type']['name'] }}</a>
                                        </h3>
