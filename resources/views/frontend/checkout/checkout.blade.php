...
@section('main')
    ...
    <section class="checkout-area pt-100 pb-70">
        <div class="container">
            <form method="POST" role="form" action="{{ route('store.checkout') }}" class="stripe_form require-validation"
                                ...
                                <div class="billing-details">
                                    ...
                                    <table class="table" style="width: 100%">
                                        ...
                                        <tr>
                                            <td>
                                                <p>Total Night <br>
                                                    <b>( {{ $book_data['check_in'] }} / {{ $book_data['check_out'] }})</b>
                                                </p>
                                            </td>
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="payment-box">
                            <div class="payment-method">
                                <p>
                                    <input type="radio" id="cash-on-delivery" class="pay_method" name="payment_method"
                                        value="COD">
