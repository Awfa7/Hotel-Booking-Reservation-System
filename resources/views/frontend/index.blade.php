...
<div class="banner-area" style="height: 480px;">
    <div class="container">
        <div class="banner-content">
            <h1>Escape the ordinary. Book your stay at our exclusive boutique hotel.</h1>
        </div>
    </div>
</div>
<!-- Banner Area End -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input autocomplete="off" required type="text" name="check_in" class="form-control dt_picker" placeholder="yyy-mm-dd">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input autocomplete="off" required type="text" name="check_out" class="form-control dt_picker" placeholder="yyy-mm-dd">
                                <span class="input-group-addon"></span>
                            </div>
                            <i class='bx bxs-chevron-down'></i>	
                        </div>
