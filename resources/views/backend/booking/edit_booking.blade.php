                            ...
                            <table class="table align-middle mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><span class="badge bg-primary">{{ $editData->check_in }}</span> /<br> <span
                                                class="badge bg-warning  text-dark">{{ $editData->check_out }}</span></td>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach ($assign_rooms as $assign_room)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('delete.assign.room', $assign_room->id) }}" id="delete">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                        ...
                        <form action="{{ route('update.booking.status', $editData->id) }}" method="POST">
                            ...
                            <div class="row" style="margin-top: 40px;">
                                ...
                                <div class="col-md-12" style="margin-top: 20px;">
                                    ...
                                    <a href="{{ route('download.booking.invoice',$editData->id) }}" class="btn btn-warning px-3 radius-10"><i class="lni lni-download"></i> Download Invoice</a>
                                </div>
                            </div>
                        </form>
                        ...
                        <form action="{{ route('update.booking', $editData->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input type="date" name="check_in" required class="form-control" id="check_in"
                                        value="{{ $editData->check_in }}">
                                </div>
                                <div class="col-md-12 mb-2">
                                    <label for="">Check Out</label>
                                    <input type="date" name="check_out" required class="form-control" id="check_out"
                                        value="{{ $editData->check_out }}">
                                </div>

                                <div class="col-md-12 mb-2">
                                    <label for="">Number Of Room</label>
                                    <input type="number" name="number_of_rooms" required class="form-control"
                                        value="{{ $editData->number_of_rooms }}">
                                </div>

                                <input type="hidden" name="available_room" class="form-control" id="available_room">
                ...
                <div class="card radius-10 w-100">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                State <span class="badge bg-warning text-dark rounded-pill">{{ $editData->state }}</span>
                            </li>
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                Zip Code <span class="badge bg-primary rounded-pill">{{ $editData->zip_code }}</span>
                            </li>
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                Address <span
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".assign_room").on('click', function() {
                $.ajax({
                    url: "{{ route('assign.room', $editData->id) }}",
