                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body p-4">
                                <form class="row g-3" action="{{ route('update.blog.post') }}" id="myForm" method="POST"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="blog_category_id" id="input7" class="form-select">
                                            ...
                                            @foreach ($blogCategory as $item)
                                                <option value="{{ $item->id }}" {{ $item->id == $post->blog_category_id ? 'selected' : '' }}>{{ $item->category_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="input1" class="form-label">Post Title</label>
                                        <input name="post_title" value="{{ $post->post_title }}" type="text" class="form-control" id="input1">
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="long_desc" class="form-control" id="myeditor">{!! $post->long_desc !!}</textarea>
                                    </div>
