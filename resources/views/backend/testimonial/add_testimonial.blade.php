        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <form action="{{ route('store.testimonial') }}" id="myForm" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
        ...
        $(document).ready(function() {
            $('#myForm').validate({
                ...
                messages: {
                    ...
                    position: {
                        required: 'Please Enter Team Member Position',
                    },
                    facebook: {
                        required: 'Please Enter Team Member Facebook URL',
                    },
                    image: {
                        required: 'Please Select Team Member Image',
                    },
                },
                errorElement: 'span',
