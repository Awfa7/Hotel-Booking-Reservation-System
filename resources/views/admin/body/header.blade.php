                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="header-notifications-list">
                                ...
                                @forelse ($user->notifications as $notification)
                                    <a class="notification dropdown-item @if (!$notification->read_at) unread @endif"
                                        id="notification-color" href="javascript:;" data-id="{{ $notification->id }}"
...
<script>
    function markNotificationAsRead(notificationId) {
        var notificationElement = document.querySelector(
            `.notification[data-id="${notificationId}"]`); // Adjust selector as needed

        if (notificationElement) {
            // Remove the "unread" background color style (if it exists)
